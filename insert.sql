...
INSERT INTO ski.kihon_tx(id_tx ,from_sequence ,to_sequence ,movement ,notes ,resource_url ) VALUES
    ...
    ( 432 , 301 , 302, 'Bkw' , NULL , NULL ),
    ( 432 , 302 , 303, 'Still' , NULL , NULL ),
    ( 432 , 303 , 304, 'Still' , NULL , NULL ),
    ( 432 , 304 , 305, 'Still' , NULL , NULL ),
    ( 435 , 306 , 307, 'Bkw' , NULL , NULL ),
    ( 436 , 307 , 308, 'Still' , NULL , NULL ),
    ( 437 , 308 , 309, 'Fwd' , NULL , NULL ),
    ( 438 , 309 , 310, 'Fwd' , NULL , NULL ),
    ( 340 , 311 , 312, 'Bkw' , NULL , NULL ),
    ( 341 , 312 , 313, 'Still' , NULL , NULL ),
    ( 342 , 313 , 314, 'Fwd' , NULL , NULL ),
    ( 345 , 315 , 316, 'Bkw' , NULL , NULL ),
    ( 346 , 316 , 317, 'Still' , NULL , NULL ),
    ( 347 , 317 , 318, 'Fwd' , NULL , NULL ),
    ( 348 , 318 , 319, 'Fwd' , NULL , NULL ),
    ( 349 , 319 , 320, 'Still' , NULL , NULL ),
    ( 353 , 321 , 322, 'Fwd' , NULL , NULL ),
    ( 354 , 322 , 323, 'Still' , NULL , NULL ),
    ( 355 , 323 , 324, 'Bkw' , NULL , NULL ),
    ( 356 , 324 , 325, 'Still' , NULL , NULL ),
    ( 357 , 326 , 327, 'Fwd' , NULL , NULL ),
    ( 358 , 327 , 328, 'Fwd' , NULL , NULL ),
    ( 359 , 328 , 329, 'Still' , NULL , NULL ),
    ( 360 , 329 , 330, 'Fwd' , NULL , NULL ),
    ( 361 , 330 , 331, 'Fwd' , $$Rotazione 180°$$ , NULL ),
    ( 364 , 332 , 333, 'Still' , NULL , NULL ),
    ( 365 , 333 , 334, 'Still' , NULL , NULL ),
    ( 366 , 334 , 335, 'Still' , NULL , NULL ),
    ( 340 , 336 , 337, 'Still' , NULL , NULL ),
    ( 343 , 340 , 341, 'Still' , NULL , NULL ),
