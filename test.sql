INSERT INTO  staging.targets(id_target ,name ,original_name ,description,notes ) VALUES
...
INSERT INTO staging.strikingparts( id_part ,name ,translation ,description ) VALUES 
...
INSERT INTO staging.kihon_sequences(id_sequence, inventory_id , seq_num,stand_id,technic_id,gyaku,target_hgt,notes,resource_url) VALUES 
...
INSERT INTO staging.kihon_tx(id_tx ,from_sequence ,to_sequence ,movement ,notes ,resource_url ) VALUES
...
INSERT INTO staging.Kata_inventory(
    id_kata ,
    kata ,
    serie ,
    starting_leg ,
...
INSERT INTO staging.kata_sequence(
    id_sequence ,
    kata_id ,
    seq_num ,
    stand_id ,
...
INSERT INTO staging.kata_sequence_waza (
    sequence_id ,
    arto ,
    technic_id ,
    technic_target_id,
